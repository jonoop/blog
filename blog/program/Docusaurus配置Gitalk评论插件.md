...
首先需要 github 账号，创建一个仓库用于存放评论，由于我的博客是同步上传到[github](https://github.com/jonoop/blog)上，所以就无需新建仓库

### 2、开启 issues 功能

默认开启，可在 Settings -> Features -> Issues 中设置

![image-20220122141447919](https://img.jonoop.com/20220122141447.png)
...
![image-20220121225059192](https://img.jonoop.com/20220121225106.png)
...
![image-20220122130221871](https://img.jonoop.com/20220122130222.png)
...
options 有个选项 repo，填写的是仓库名称，不是链接，像上面我所填写的就是`blog`，而不是填写https://github.com/jonoop/blog

### 未找到相关的 [Issues](https://github.com/jonoop/blog/issues) 进行评论，请联系 @xxxxx 初始化创建
...
其中在[第 3 步](#3注册一个-github-applications)的 Authorization callback URL 地址一定要填写成现在博客线上环境 http://jonoop.com ，否则也无法正常使用
...
[查看完整源码点我](https://github.com/jonoop/blog/blob/main/src/theme/BlogPostPage/index.jsx)
...
![image-20220122164034147](https://img.jonoop.com/20220122164034.png)

#### issues 页面

![image-20220122163957435](https://img.jonoop.com/20220122163957.png)
