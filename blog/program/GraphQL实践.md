...
![](https://img.jonoop.com/image_Y4u9tNpZwR.png)
...
仓库本文实例代码仓库： [Jon/nest-graphql-demo](https://github.com/jonoop/nest-graphql-demo 'Jon/nest-graphql-demo')
...
这里我就选用 [Jon/vitesse-nuxt-strapi](https://github.com/jonoop/vitesse-nuxt-strapi 'Jon/vitesse-nuxt-strapi') 作为演示，并为其提供 graphQL 支持。
