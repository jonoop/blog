...
在线地址: [KZ API](https://api.jonoop.com)

开源地址: [kuizuo/api-service](https://github.com/jonoop/api-service)

![KZ API](https://img.jonoop.com/KZ%20API.png)
...
![image-20220714005704602](https://img.jonoop.com/image-20220714005704602.png)

初始的 nuxt3 项目及其简单，甚至没有 page、components、assets 等目录。

![image-20220714003726413](https://img.jonoop.com/image-20220714003726413.png)
...
![vitesse-nuxt3](https://img.jonoop.com/vitesse-nuxt3.png)
